...
const AddProduct = () => {
  ...
  const addProduct = async () => {
    try {
      ...
      await axios.post(`${import.meta.env.VITE_APP_API_BASE_URL}/products/add-product`, formData);
          ...
          <form>
            ...
            <Flex columnGap="10px" mb="20px " flexDir={{ md: "row", sm: "column" }}>
              <Box width="40%">
                ...
                <Input
                  value={quantity.toString()} // Convert number to string for Input component
